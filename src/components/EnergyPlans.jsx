        ...
        <div className="flex justify-between max-lg:flex-wrap max-lg:justify-center">
          ...
          <div className='lg:w-6/12 w-full max-lg:pt-10'>
            ...
            <ul className='ml-4 pt-7 max-md:py-7 pb-[42px]'>
              <li className='list-disc text-[#00171F] text-base font-normal leading-6 max-w-[382px]'>Save money by finding cheaper deals.</li>
              <li className='list-disc pt-2 text-[#00171F] text-base font-normal leading-6 max-w-[382px]'>Get better customer service.</li>
              <li className='list-disc pt-2 text-[#00171F] text-base font-normal leading-6 max-w-[382px] '>Explore greener, more sustainable energy options.</li>
            </ul>
